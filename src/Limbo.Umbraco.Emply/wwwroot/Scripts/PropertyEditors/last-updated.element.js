...
customElements.define("limbo-umbraco-emply-last-updated-property-editor", LimboUmbracoEmplyLastUpdatedPropertyEditor);
export { LimboUmbracoEmplyLastUpdatedPropertyEditor as element };
