...
public class EmplyRecurringTask : RecurringHostedServiceBase {
    ...
    public EmplyRecurringTask(ILogger<EmplyRecurringTask> logger, IOptions<EmplySettings> settings, EmplyJobsService emplyJobsService, IRuntimeState runtimeState) : base(logger, settings.Value.Scheduling.Interval, settings.Value.Scheduling.Delay) {
